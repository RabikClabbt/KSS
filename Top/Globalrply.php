...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_POST = array();
    header('Location: ' . $_SERVER['PHP_SELF'] . '?commentID=' . $rplyID);
    exit();
}
...
<body>
    ...
    <div class="main-content">
        <div class="post">
                ...
                <div class="chat-comment">
                    <div class="account">
                        <div class="account-image">
                            <?php if (!empty($comment['profileIcon'])): ?>
                                <a href="../Profile/Profile.php"><img src="<?= htmlspecialchars($comment['profileIcon']) ?>" alt="ProfileImage"></a>
                            <?php else: ?>
                                <a href="../Profile/Profile.php"><img src="../image/DefaultIcon.svg" alt="ProfileImage"></a>
                            <?php endif; ?>
                        </div>
                    ...
                    <?php if (!empty($comment['appendFile'])): ?>
                        <div class="attached-file">
                            <a href="<?= htmlspecialchars($comment['appendFile']) ?>" download>添付ファイルをダウンロード</a>
                        </div>
                    <?php endif; ?>
                </div>
                <!-- 入力フォーム -->
            ...
            <!-- リプライ表示 -->
            <div class="rply-comments">
                <?php foreach ($replies as $rply): ?>
                    <div class="rply-comment">
                        <div class="rplyaccount">
                            <div class="rplyaccount-image">
                                ...
                                <?php else: ?>
                                    <img src="../image/DefaultIcon.svg" alt="ProfileImage">
                                <?php endif; ?>
                            </div>
